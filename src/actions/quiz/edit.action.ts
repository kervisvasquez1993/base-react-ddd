...
export const editQuizAction = async (token: string, quizId: number, quizData: QuizPayload): Promise<QuizResponse> => {
    try {
        const response = await ApiBackend.put(`/api/quiz/${quizId}`, quizData, {
            headers: {
